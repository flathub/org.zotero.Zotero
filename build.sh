  ...
  "modules": [
    "shared-modules/dbus-glib/dbus-glib.json",
    {
      ...
      "build-commands": [
        ...
        "desktop-file-install --dir=/app/share/applications --set-key=Exec --set-value='zotero -url %U' --set-key=Icon --set-value=org.zotero.Zotero zotero.desktop --set-key=Version --set-value='1.5' --set-key=X-GNOME-SingleWindow --set-value=true --add-mime-type=x-scheme-handler/zotero",
